...
import { ChevronDown, ChevronUp, Currency, CurrencyIcon, EyeClosed, Search, Star, Trash, Users } from "lucide-react";
                ...
                <div className={doctorListStyles.headerTopSection}>
                    ...
                    <div className={doctorListStyles.headerSearchContainer}>
                        <div className={doctorListStyles.searchBox}>
                            ...
                            <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search Doctors, specialization" />
                        </div>
