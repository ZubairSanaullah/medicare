...
import { Calendar, CalendarRange, Check, CheckCircle, ChevronDown, ChevronUp, ClipboardCheck, CurrencyIcon, Search, X, XCircle, XCircleIcon } from "lucide-react";
        ...
        <div className={serviceDashboardStyles.container}>
            <div className={serviceDashboardStyles.innerContainer}>
                ...
                <div className={serviceDashboardStyles.header.container}>
                    <div>
                        <h1 className={serviceDashboardStyles.header.title}>Manage Services</h1>
                        <p className={serviceDashboardStyles.header.subtitle}>
                            Overview of all services and their appointments
                        </p>
                    </div>
                    ...
                    <div className={serviceDashboardStyles.refresh.container}>
                        ...
                        <button
                            ...
                            title={Array.isArray(servicesProp) ? "Services provided by parent component" : "Refresh"}
                        >
                            Refresh
                        </button>
                    </div>
                ...
                <div className={serviceDashboardStyles.search.container}>
                    <div className={serviceDashboardStyles.search.inputContainer}>
                        ...
                        {searchQuery.length > 0 && (
                            <XCircleIcon
                                size={16}
                                className="text-rose-500 cursor-pointer hover:opacity-80"
                                ...
                                return (
                                    <div key={s.id} className={serviceDashboardStyles.table.row}>
                                        ...
                                        <div className={serviceDashboardStyles.table.desktopView}>
                                            ...
                                            <div className={serviceDashboardStyles.table.desktopCell(1)}>
                                                {s.completed}
                                            </div>
                                            ...
                                            <div className={`${serviceDashboardStyles.table.desktopCell(2)} text-right text-emerald-600 font-semibold`}>
                                                {formatCurrency(earning)}
                                            </div>
                                        </div>
