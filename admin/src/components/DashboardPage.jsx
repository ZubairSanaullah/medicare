import { CalendarRange, ChartCandlestick, CheckCircle, ScatterChart, Search, UserRoundCheck, Users, Users2, XCircle } from "lucide-react";
...
const DashboardPage = () => {
    ...
    const [patientCountingLoading, setPatientCountLoading] = useState(false);
            ...
            <div className={s.maxWidthContainer}>
                <div className={s.headerContainer}>
                    <div>
                        ...
                        <p className={s.headerSubtitle}>Overview of doctors & patients. </p>
                    </div>
                </div>
                ...
                <div className={s.statsGrid}>
                    ...
                    <StatCard icon={<ChartCandlestick className="w-6 h-6" />}
    ...
    return (
        <div className={s.mobileDoctorCard}>
            <div className={s.mobileDoctorHeader}>
                ...
                <div className={s.mobileDoctorFee}>Rs. {d.fee}</div>
            </div>

            <div className={s.mobileStatsGrid}>
                <div>
                    <div className={s.mobileStatLabel}>Aptts</div>
