...
import { AlertCircle, Calendar, CheckCircle, Clock1, Image, Plus, PlusCircle, Trash2, XCircle } from "lucide-react";
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
                    <div>
                        ...
                        <p className={addServiceStyles.header.subtitle}>
                            Create a beautiful service card with rich information
                        </p>
                    </div>
