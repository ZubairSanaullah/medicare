...
import { Loader2, Loader2Icon, Search, SearchIcon, X, CheckCircle, XCircle, User, Calendar, Clock, Phone, CreditCard } from "lucide-react";
        ...
        <div className={serviceAppointmentsStyles.container}>
            <header className={serviceAppointmentsStyles.headerContainer}>
                <div className={serviceAppointmentsStyles.headerTitleContainer}>
                    ...
                    <p className={serviceAppointmentsStyles.headerSubtitle}>
                        Manage all service appointments & its scheduling
                    </p>
                </div>
                    ...
                    <div className={serviceAppointmentsStyles.searchInputWrapper}>
                        <label className={serviceAppointmentsStyles.searchLabel}>
                            ...
                            <div className="flex items-center gap-2 relative w-full">
                                ...
                                <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search Appointments..." className={serviceAppointmentsStyles.searchInput} />
                                {search ? (
                                    <button
                                        onClick={() => setSearch("")}
                                    ...
                                    >
                                        <X className={serviceAppointmentsStyles.clearSearchIcon} />
                                    </button>
                                ) : (
            ...
            {loading ? (
                <div className={serviceAppointmentsStyles.loadingContainer}>
                    <Loader2Icon className="animate-spin" /> Loading appointments....
                </div>
            ) : error ? (
                ...
                <div className={serviceAppointmentsStyles.gridContainer}>
                    {displayList.length === 0 ? (
                        <div className={serviceAppointmentsStyles.noResultsContainer}>
                            <SearchIcon className={serviceAppointmentsStyles.noResultsIcon} />
                            <div className={serviceAppointmentsStyles.noResultsText}>
                                No appointments found {search ? `with "${search}"` : ""}.
                            </div>
                            <div className={serviceAppointmentsStyles.noResultsSubtext}>
                                Try a different search or filters, or {statusFilter ? `` : ""}
                            </div>
                        </div>
                    ) : (
                        displayList.map((a) => {
            ...
            <div className={serviceAppointmentsStyles.legendContainer}>
                ...
                <div className={serviceAppointmentsStyles.legendItem}>
                    <div className={`${serviceAppointmentsStyles.legendDot} bg-rose-400`}></div>
                    <span>Cancelled</span>
                </div>
                ...
                <div className={serviceAppointmentsStyles.legendItem}>
                    <div className={`${serviceAppointmentsStyles.legendDot} bg-violet-400`}></div>
