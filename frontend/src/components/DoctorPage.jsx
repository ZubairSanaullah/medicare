        ...
        <div className={doctorsPageStyles.mainContainer}>
            ...
            <div className={doctorsPageStyles.wrapper}>
                <div className={doctorsPageStyles.headerContainer}>
                    ...
                    <p className={doctorsPageStyles.headerSubtitle}>Consult with the best doctors and get personalized healthcare advice.</p>
                </div>
                    ...
                    <div className={doctorsPageStyles.searchWrapper}>
                        ...
                        {searchTerm.length > 0 && (
                            <button onClick={() => setSearchTerm("")} className={doctorsPageStyles.clearButton}>
                                <X size={20} strokeWidth={2.5} className="cursor-pointer transition" />
                            </button>
                        )}
                    </div>
                </div>
                ...
                {error && (
                    <div className={doctorsPageStyles.errorContainer}>
                        ...
                        <div className="flex items-center justify-center gap-3">
                            <button className={doctorsPageStyles.retryButton} onClick={retry}>
                                Retry
                            </button>
                        </div>
                    </div>
                ...
                {loading ? (
                    ...
                    <div className={`${doctorsPageStyles.doctorsGrid} ${filteredDoctors.length === 0 ? "opactiy-70" : "opacity-100"}`}>
