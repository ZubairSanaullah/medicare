            ...
            <div className={listPageStyles.contentWrapper}>
                <div className={listPageStyles.headerContainer}>
                    <div>
                        ...
                        <p className={listPageStyles.headerSubtitle}>Manage all your appointments in one place</p>
                    </div>
                    ...
                    <div className={listPageStyles.searchFilterContainer}>
                        <div className={listPageStyles.searchContainer}>
                            ...
                            <input value={search} onChange={(e) => setSearch(e.target.value)} className={listPageStyles.searchInput} placeholder="Search patient" />
                            {search && (
                                <button
                                    onClick={() => setSearch("")}
                        ...
                        {filtered.map((a) => (
                            <article key={a.id} className={listPageStyles.appointmentCard}>
                                ...
                                <div className={listPageStyles.dateTimeSection}>
                                    ...
                                    <div className={listPageStyles.feeText}>Rs.{a.fee}</div>
                                </div>
