...
// To convert the time from 12 hours to 24 hours format and then convert to minutes
...
// Parse schedule input to ensure it's a plain object with deduplicated and sorted slots
    ...
    try {
        ...
        if (!secret) {
            ...
            return res.status(500).json({
                success: false,
                message: "Server error: JWT secret not configured. Please contact the administrator."
            });
        }
