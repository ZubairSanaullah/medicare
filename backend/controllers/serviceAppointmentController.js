...
// To create the service payment
export const confirmServiceAppointment = async (req, res) => {
    try {
        ...
        console.error("confirmServiceAppointment error:", error);
        res.status(500).json({ success: false, message: "Failed to confirm appointment" });
    }
}

// To get service appointments 
export const getServiceAppointments = async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: "Failed to get service appointments" });
    }
}
...
export const getServiceAppointmentById = async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: "Failed to get service appointment" });
    }
}

// To update service appointment
export const updateServiceAppointment = async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: "Failed to update service appointment" });
    }
}
...
export const cancelServiceAppointment = async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: "Failed to cancel service appointment" });
    }
}
...
export const getServiceAppointmentStats = async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: "Failed to get service appointment statistics" });
    }
}
...
export const getServiceAppointmentsByPatient = async (req, res) => {
    try {
        ...
        const list = (await ServiceAppointment.find(filter)).toSorted({ createAt: -1 }).lean();
        return res.json({
            success: true,
            data: list
        })
        ...
        console.error("getPatientServiceAppointments error:", error);
        res.status(500).json({ success: false, message: "Failed to get patient service appointments" });
    }
}
